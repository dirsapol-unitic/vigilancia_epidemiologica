...
@else
    ...
    function reporteAislados(){
        ...
        var f_riesgo = $('#f_riesgo').val();
        var factor_x = $('#factor_x').val();
        ...
        if (distrito == "" || distrito == null)distrito = 0;        
        estado =0;

        if (f_riesgo == "" || factor_x==0){
                f_riesgo = 0;
        }
        else
        {   if (factor_x!=0){
        ...
        location.href = 'exportar_reporte_aislamientos/' + fechaDesde + '/' + fechaHasta  + '/' + departamento + '/' + provincia + '/' + distrito + '/' + dni_beneficiario + '/' + estado + '/' + f_riesgo;

    }

    function reporteSolucion(){
        ...
        location.href = 'exportar_reporte_soluciones/' + fechaDesde + '/' + fechaHasta  + '/' + id_medico + '/' + dni_beneficiario + '/' + f_riesgo + '/' + estado;
    }

    function ver_det_reclamacion(idUser, nro_reclamacion, id_reclamacion, id_ipress){
        $('#nrorecmodal').text(nro_reclamacion);
        $.ajax({
        url: '/ver_reclamacion_atendida/2/' + idUser + '/' + nro_reclamacion + '/' + id_reclamacion + '/' + id_ipress,
                async: false,
