    ...
    <div class="box-body">
        <div class="row col-sm-12">
            ...
            <div class="form-group col-sm-3 " id="divalta">
                ...
                <input type="date" tabindex="48"   name="fecha_alta" id="fecha_alta" class="form-control" value="<?php echo $paciente->fecha_alta; ?>" >
                </div>
            </div>
            <div class="row col-sm-12" id="divdefuncion">
                <div class="row col-sm-12">
                    ...
                    <div class="form-group col-sm-3">
                        ...
                        <input type="date" tabindex="50"   name="fecha_defuncion" id="fecha_defuncion" class="form-control" value="<?php echo $paciente->fecha_defuncion; ?>" >
                    </div>
