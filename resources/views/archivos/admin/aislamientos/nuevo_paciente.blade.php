        ...
        <div class="box-body">
            <div class="row">
                ...
                <div class="form-group col-sm-7">
                    ...
                    <input type="hidden" name="situacion" id="situacion">
                </div>
        ...
        <div class="box-body">
            ...
            <div class="row col-sm-12">
                ...
                <div class="form-group col-sm-2">
                    ...
                    <input type="text" required="" tabindex="12" name="parentesco" id="parentesco" class="form-control">
                </div>
            </div>
            <div class="row col-sm-12">
                <div class="form-group col-sm-3">
            ...
            <div class="row col-sm-12">
                ...
                <div class="form-group col-sm-2">
                    ...
                    <select class="form-control select2" onchange="getOtraNacionalidad();" tabindex="20" required="" name="nacionalidad" id="nacionalidad">
                        <option value="0">- Seleccione -</option>
                ...
                <div class="form-group col-sm-2">
                    ...
                    <select class="form-control select2" tabindex="22" onchange="getOtroMigrante();"required="" name="migrante" id="migrante">
                    <option value="0">- Seleccione -</option>
        ...
        <div class="box-body">
            <div class="row col-sm-12">
                <div class="form-group col-sm-3">
                    ...
                    <input type="date" tabindex="28"  required="" name="fecha_sintoma" id="fecha_sintoma" class="form-control" value="<?php echo date("Y-m-d", strtotime($fechaServidor)); ?>" >
                </div>
                <div class="form-group col-sm-3">
                    <label>Fecha  de inicio de aislamiento</label><br/>
                    <input type="date" tabindex="29"  required="" name="fecha_aislamiento" id="fecha_aislamiento" class="form-control" value="<?php echo date("Y-m-d", strtotime($fechaServidor)); ?>" >
                </div>
                <div class="form-group col-sm-2">
                    <label>Departamento:</label><br/>
            ...
            <div class="row col-sm-12">
                ...
                <div class="row col-sm-12">
                    ...
                    <div class="form-group col-sm-4">
                        ...
                        <br/>
                        <select class="form-control select2" tabindex="37" onchange="getOtroContacto();" required="" name="contacto_directo" id="contacto_directo">
                            <option value="0">- Seleccione -</option>
                            <option value="SI"> SI </option>
                            <option value="NO"> NO </option>
                    ...
                    <div class="form-group col-sm-4">
                        ...
                        <br/>
                        <select class="form-control select2" tabindex="38" required="" name="ficha_contacto" id="ficha_contacto">
                            <option value="0">- Seleccione -</option>
                            <option value="SI"> SI </option>
                            <option value="NO"> NO </option>
                        </select>
                        ...
                        <br/>
                        <select class="form-control select2" tabindex="39" required="" name="caso_reinfeccion" id="caso_reinfeccion">
                            <option value="0">- Seleccione -</option>
                            <option value="SI"> SI </option>
                            <option value="NO"> NO </option>
                        </select>
                        ...
                        <select class="form-control select2" tabindex="40" required="" name="servicio_hospitalizacion" id="servicio_hospitalizacion">
                                <option value="0">- Seleccione -</option>
                ...
                <div class="col-md-12">                
                    ...
                    <textarea rows="10" type="text" tabindex="41" required="" name="indicacion" id="indicacion" class="ckeditor"></textarea>                                
                    <br/><br/><br/>
                </div>
                <div class="col-md-12">                
                    <label>Motivo del aislamiento</label> <br/>                                
                    <textarea rows="10" type="text" tabindex="42" required="" name="observacion" id="observacion" class="ckeditor"></textarea>                                
                    <br/><br/><br/>
                </div>
