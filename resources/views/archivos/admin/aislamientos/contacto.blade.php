    ...
    <div class="box-body">
        ...
        <div class="row col-sm-12">
            ...
            <div class="form-group col-sm-3">
                ...
                <input type="text" tabindex="73"   name="fecha_nacimiento_contacto" id="fecha_nacimiento_contacto" class="form-control" maxlength="10" value="<?php echo $fecha_nacimiento_contacto;?>">
            </div>
            <div class="form-group col-sm-3">
        ...
        <div class="row col-sm-12">
            <div class="row col-sm-6">
                <div class="form-group col-sm-6">
                    ...
                    <input type="date" tabindex="82"  required="" name="fecha_cuarentena_contacto" id="fecha_cuarentena_contacto" class="form-control" value="<?php echo $fecha_cuarentena_contacto;?>" >
                        <br/><br/>
                        ...
                        <tr>
                            <td>
                                <input 
                                        ...
                                        {{ $aislamientos->factorcontactos->pluck('id')->contains($friesgo->id) ? 'checked' : '' }}
