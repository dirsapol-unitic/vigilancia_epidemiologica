                        ...
                        <form id="frm_asilamientos_pnp" class="form-horizontal" method="post" action="{{ route('aislamientos.listar_aislamientos')}}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select class="form-control input-sm select2" name="provincia" id="provincia" tabindex="16" style="width: 100%">
                                    </select>
                                </div> 
                                <div class="col-md-3">
                                    <label class="control-label">Distritos</label>
                                    <select class="form-control input-sm select2" name="distrito" id="distrito" tabindex="16" style="width: 100%">
                                    </select>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <br/><br/>
                                    <a class="btn btn-success form-control input-sm" href="javascript:void(0)" onclick="reporteAislados()" >
                        ...
                        <table id="example" class="table table-list-search table-hover" style="font-size: 11px !important;" >
                            <thead>
                                <tr>
                                    ...
                                    <th>Beneficiario</th>
                                    <th>Seguro</th>
                                    <th>Servicio de Hospitalizacion</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div data-toggle="tooltip" data-placement="top" data-html="true" title="<b>Evolucion</b>">
                                            <a href="/registro_evolucion/{{$r->id}}/{{$r->dni}}" class="btn btn-primary btn-xs"><i class="fa fa-fw fa-edit"></i></a>
                                        </div>                                    
                                    </td>
                                </tr>
                                @endforeach                      
