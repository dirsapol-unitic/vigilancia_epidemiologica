    ...
    <div class="box-body">
        <div class="row col-sm-12">
            <div class="form-group col-sm-3">
                <label>DNI</label><br/>
                <input readonly="" type="text" required="" tabindex="1" name="dni" id="dni" class="form-control" maxlength="8" value="{{$paciente->dni}}">
            </div>
            <div class="form-group col-sm-3">
                <label>Nombres</label> <br/>
                <input readonly="" type="text" required=""  tabindex="2" name="name" id="name" class="form-control" value="{{$paciente->nombres}}">
            </div>
            <div class="form-group col-sm-3">
                <label>Apellido Paterno</label><br/>
                <input readonly="" type="text" required="" tabindex="3" name="paterno" id="paterno" class="form-control" value="{{$paciente->paterno}}">
            </div>
            <div class="form-group col-sm-3">
                <label>Apellido Materno</label><br/>
                <input readonly="" type="text" required="" tabindex="4" name="materno" id="materno" class="form-control" value="{{$paciente->materno}}">
            </div>
        </div>
        <div class="row col-sm-12">
            <div class="form-group col-sm-2">
                <label>CIP</label> <br/>
                <input type="text" tabindex="5" name="cip" id="cip" class="form-control" maxlength="8" value="{{$paciente->cip}}">
            </div>
            <div class="form-group col-sm-2">
                <label>Grado</label><br/>
                <input type="text" tabindex="6" name="grado" id="grado" class="form-control" value="{{$paciente->grado}}">
            </div>
            <div class="form-group col-sm-2">
            ...
            <div class="form-group col-sm-2">
                ...
                <input readonly="" type="text" tabindex="8"  required="" name="fecha_nacimiento" id="fecha_nacimiento" class="form-control" maxlength="10" value="{{$paciente->fecha_nacimiento}}">
            </div>
            <div class="form-group col-sm-2">
                <label>Parentesco</label><br/>
                <input readonly type="text" required="" tabindex="9" name="parentesco" id="parentesco" class="form-control" value="{{$paciente->parentesco}}">
            </div>
            <div class="form-group col-sm-2">
                <label>Situacion</label><br/>
                <input readonly="" type="text" required="" tabindex="9" name="situacion" id="situacion" class="form-control" value="{{$paciente->situacion}}">
            </div>
        </div>
        <div class="row col-sm-12">
            <div class="form-group col-sm-3">
                <label>Unidad</label><br/>
                <input type="text" tabindex="10" name="unidad" id="unidad" class="form-control" value="{{$paciente->unidad}}">
            </div>
            <div class="form-group col-sm-3">
            ...
            <div class="form-group col-sm-2">
                ...
                <input type="text" tabindex="13" name="talla" id="talla" class="form-control" maxlength="3" value="{{$paciente->talla}}">
            </div>
            <div class="form-group col-sm-2">
        ...
        <div class="row col-sm-12">
            <div class="form-group col-sm-2">
                ...
                <select class="form-control select2" tabindex="15" name="etnia" id="etnia">
                    <option value="0">- Seleccione -</option>
            ...
            <div class="form-group col-sm-2">
                ...
                <select class="form-control select2" tabindex="17" name="nacionalidad" id="nacionalidad">
                    <option value="0">- Seleccione -</option>
            ...
            <div class="form-group col-sm-2">
                ...
                <select class="form-control select2" tabindex="19" onchange="getOtroMigrante();" name="migrante" id="migrante">
                <option value="0">- Seleccione -</option>
...
<div class="box-body">
    <div class="form-group col-sm-12">
        <input type="hidden" name="opcion" id="opcion" value="datospaciente">
