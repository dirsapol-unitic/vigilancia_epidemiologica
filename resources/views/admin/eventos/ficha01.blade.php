        ...
        <div class="box-body">
            <div class="row">
                ...
                <div class="form-group col-sm-7">
                    ...
                    <input type="hidden" name="situacion" id="situacion" value="">
                </div>
    ...
    <div class="box box-primary">
        <div class="box-body">
            ...
            <div class="row col-sm-12">
                <div class="form-group col-sm-3">
                    <label>CIP</label> <br/>
                    <input type="text" required="" tabindex="8" name="cip" id="cip" class="form-control" maxlength="8">
                </div>
                <div class="form-group col-sm-3">
                    <label>Grado</label><br/>
                    <input type="text" required="" tabindex="9" name="grado" id="grado" class="form-control">
                </div>
                <div class="form-group col-sm-2">
                ...
                <div class="form-group col-sm-2">
                    ...
                    <input type="text" name="telefono" tabindex="12" id="telefono" maxlength="9" class="form-control">
                </div>
            </div>
            <div class="row col-sm-12">
                <div class="form-group col-sm-3">
                    <label>Unidad</label><br/>
                    <input type="text" required="" tabindex="13" name="unidad" id="unidad" class="form-control">
                </div>
                <div class="form-group col-sm-3">
                ...
                <div class="form-group col-sm-2">
                    ...
                    <input type="text" required="" tabindex="15" name="peso" id="peso" maxlength="5" class="form-control">
                </div>
                <div class="form-group col-sm-2">
                    <label>Talla (centimetros)</label><br/>
                    <input type="text" required="" tabindex="16" name="talla" id="talla" class="form-control" maxlength="3">
                </div>
                <div class="form-group col-sm-2">
                    <label>Parentesco</label><br/>
                    <input type="text" required="" tabindex="17" name="parentesco" id="parentesco" class="form-control">
                </div>
            </div>
            <div class="row col-sm-12">
                <div class="form-group col-sm-2">
                ...
                <div class="form-group col-sm-2 " id="divetnia">
                    ...
                    <input type="text" tabindex="17" name="otra_raza" id="otra_raza" class="form-control">
                </div>
                <div class="form-group col-sm-2">
                    <label>Nacionalidad:</label><br/>
                    <select class="form-control select2" onchange="getOtraNacionalidad();" tabindex="19" required="" name="nacionalidad" id="nacionalidad">
                        <option value="0">- Seleccione -</option>
                ...
                <div class="form-group col-sm-2" id="divnacion" style="display:none">
                    ...
                    <input type="text" tabindex="17" name="otra_nacion" id="otra_nacion" class="form-control">
                </div>
                <div class="form-group col-sm-2">
                    <label>Migrante:</label><br/>
                    <select class="form-control select2" tabindex="20" onchange="getOtroMigrante();"required="" name="migrante" id="migrante">
                    <option value="0">- Seleccione -</option>
                ...
                <div class="form-group col-sm-2" id="divmigrante" style="display:none">
                    <label>Registrar Nacion:</label><br/>
                    <input type="text" tabindex="17" name="otro_migrante" id="otro_migrante" class="form-control">
                </div>
            </div>
            <div class="row col-sm-12">
                <div class="form-group col-sm-6">
                    <label>Domicilio:</label><br/>
                    <input type="text" tabindex="21" name="domicilio" id="domicilio" class="form-control">
                </div>
        ...
        <div class="box-body">
            ...
            <div class="row col-sm-12">
                <div class="form-group col-sm-4">
                    ...
                    <input type="text" tabindex="17" name="otro_sintoma" id="otro_sintoma" class="form-control">
                </div>
                <div class="form-group col-sm-4">
                    <br/>
                    <label>Signos</label> 
                    ...
                    <label>Otro, especificar:</label><br/>
                    <input type="text" tabindex="17" name="otro_signo" id="otro_signo" class="form-control">
                </div>
                <div class="form-group col-sm-4">
                    <br/>
                    ...
                    <label>Otro, especificar:</label><br/>
                    <input type="text" tabindex="17" name="otro_factor_riesgo" id="otro_factor_riesgo" class="form-control">
                </div>
                ...
                <div class="row col-sm-12">
                    <div class="form-group col-sm-4">
                        ...
                        <label>Otro, especificar:</label><br/>
                        <input type="text" tabindex="17" name="otra_ocupacion" id="otra_ocupacion" class="form-control">
                    </div>
                    <div class="form-group col-sm-4">
                        <br/>
                    ...
                    <div class="form-group col-sm-4">
                        ...
                        <br/>
                        <select class="form-control select2" tabindex="30" required="" name="ficha_contacto" id="ficha_contacto">
                            <option value="0">- Seleccione -</option>
                            <option value="SI"> SI </option>
                            <option value="NO"> NO </option>
                        </select>
                        ...
                        <br/>
                        <select class="form-control select2" tabindex="30" required="" name="caso_reinfeccion" id="caso_reinfeccion">
                            <option value="0">- Seleccione -</option>
                            <option value="SI"> SI </option>
                            <option value="NO"> NO </option>
                        </select>
                ...
                <div class="col-md-12">                
                    ...
                    <textarea rows="10" type="text" tabindex="25" required="" name="indicacion" id="indicacion" class="ckeditor"></textarea>                                
                    <br/><br/><br/>
                </div>
                <div class="col-md-12">                
