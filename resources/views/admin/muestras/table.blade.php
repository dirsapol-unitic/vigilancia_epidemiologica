                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    @foreach($muestras as $key => $muestra)
                        <tr>
                            ...
                            <td>
                                {!! Form::open(['route' => ['muestras.destroy', $muestra->id], 'method' => 'delete']) !!}
                                <div class='btn-group'>
                                    <a href="{!! route('muestras.edit', [$muestra->id]) !!}" class='btn btn-primary btn-xs'><i class="glyphicon glyphicon-edit"></i></a>
