        ...
        <div class="box-body">
            <div class="row col-sm-12">
                <div class="form-group col-sm-3">
                    ...
                    <input type="date" tabindex="26"  name="fecha_sintoma" id="fecha_sintoma" class="form-control" value="<?php echo date("Y-m-d", strtotime($paciente->fecha_sintoma)); ?>" >
                </div>
                <div class="form-group col-sm-3">
                    <label>Fecha  de inicio de aislamiento</label><br/>
                    <input type="date" tabindex="27"  name="fecha_aislamiento" id="fecha_aislamiento" class="form-control" value="<?php echo date("Y-m-d", strtotime($paciente->fecha_aislamiento)); ?>" >
                </div>
            ...
            <div class="row col-sm-12">
                        ...
                        @foreach($sintomas as $id => $sintoma)
                            <tr>
                                <td>
                                    ...
                                    type="checkbox" 
                                    value="{{ $sintoma->id }}"
                                    {{ $paciente->sintomaaislados->pluck('id')->contains($sintoma->id) ? 'checked' : '' }}
                                    name="sintomas[]">
                                </td>
                        ...
                        @foreach($signos as $id => $signo)
                            <tr>
                                <td><input 
                                    ...
                                    {{ $paciente->signoaislados->pluck('id')->contains($signo->id) ? 'checked' : '' }}
                                    name="signos[]">
                                </td>
                        ...
                        @foreach($factorriesgos as $id => $friesgo)
                            <tr>
                                <td>
                                    ...
                                    {{ $paciente->factoraislados->pluck('id')->contains($friesgo->id) ? 'checked' : '' }}
                                    name="factorriesgos[]">
                                </td>
                                ...
                                @foreach($lugares as $id => $lugar)
                                    <tr>
                                        <td>
                                            ...
                                            {{ $paciente->lugaraislados->pluck('id')->contains($lugar->id) ? 'checked' : '' }}
                                            name="lugar[]">
                                        </td>
                ...
                <div class="col-md-12">                
                    ...
                    <textarea rows="10" type="text" tabindex="44" name="indicacion" id="indicacion" class="ckeditor"><?php echo $paciente->indicacion;?></textarea>                                
                    <br/><br/><br/>
                </div>
                <div class="col-md-12">                
                    <label>Motivo del aislamiento</label> <br/>                                
                    <textarea rows="10" type="text" tabindex="45" name="observacion" id="observacion" class="ckeditor"><?php echo $paciente->motivo;?></textarea> 
