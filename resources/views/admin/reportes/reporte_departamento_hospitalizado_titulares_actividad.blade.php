    ...
    <div class="box box-primary">
        <div class="box-body">
            <div class="panel-heading">
                <h3 class="panel-title">Reporte de Hospitalizados Titulares en Actividad</h3>
            </div>
            <div class="col-sm-12">
                <form id="frm_asilamientos_pnp" class="form-horizontal" method="post" action="{{ route('aislamientos.reporte_departamento_hospitalizado_titulares_actividad_fecha')}}">
