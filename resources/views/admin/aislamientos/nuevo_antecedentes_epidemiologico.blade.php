                  ...
                  <div class="box-body">
                    <div class="row col-sm-12">
                      <div class="form-group col-sm-2">
                          ...
                          <input type="date" tabindex="3"  required="" name="fecha_notificacion" id="fecha_notificacion" class="form-control" value="<?php echo date("Y-m-d", strtotime($fechaServidor)); ?>" >
                      </div>
                      <div class="form-group col-sm-2">
                      ...
                      <div class="form-group col-sm-2">
                        ...
                        <select class="form-control select2" tabindex="1" required="" onchange="getTipoCaso();" name="id_tipo_caso" id="id_tipo_caso">
                      ...
                      <div class="form-group col-sm-2">
                          ...
                          <input type="date" tabindex="29"  name="fecha_aislamiento" id="fecha_aislamiento" class="form-control" value="" >
                      </div>
                    </div>
                    <!-- /.box-col -->
                    <div class="row col-sm-12">
                    ...
                    <div class="row col-sm-12">
                      <div class="form-group col-sm-4">
                        ...
                        <select class="form-control select2" tabindex="37" onchange="getOtroContacto();" name="contacto_directo" id="contacto_directo">
                          ...
                          <option value="NN">Desconocido</option>
                        </select>
                        ...
                        <table class="table table-bordered table-striped" id="ejemplo1" cellspacing="0" width="100%" style="margin-top:5px;">
                          <tbody>
                              <tr>
                                ...
                                <td><input type="date" tabindex="3"   name="fecha_vacunacion_1" id="fecha_vacunacion_1" class="form-control" value="<?php echo $fechaServidor; ?>"></td>
                              ...
                              <tr>
                                ...
                                <td><b>Fecha de Vacunacion</b></td>
                                <td>
                                  <input type="date" tabindex="3"  name="fecha_vacunacion_2" id="fecha_vacunacion_2" class="form-control" value="<?php echo $fechaServidor; ?>">
                                </td>
                                <td><b>Tipo de Vacuna</b></td>
                                <td>
                              ...
                              <tr>
                                ...
                                <td><b>Fecha de Vacunacion</b></td>
                                <td>
                                  <input type="date" tabindex="3"  name="fecha_vacunacion_3" id="fecha_vacunacion_3" class="form-control" value="<?php echo $fechaServidor; ?>">
                                </td>
                                <td><b>Tipo de Vacuna</b></td>
                                <td>
                              ...
                              <tr>
                                ...
                                <td><b>Fecha de Vacunacion</b></td>
                                <td>
                                  <input type="date" tabindex="3"  name="fecha_vacunacion_4" id="fecha_vacunacion_4" class="form-control" value="<?php echo $fechaServidor; ?>">
                                </td>
                                <td><b>Tipo de Vacuna</b></td>
                                <td>
                    ...
                    <div class="col-md-12">
                      <div  id="divreinfeccion" style="display:none">
                        <div class="form-group col-sm-12">
                          ...
                          <div class="form-group col-sm-4">
                            <label>Fecha  de inicio de sintomas</label><br/>
                            <input type="date" tabindex="30"  name="fecha_sintoma_reinfeccion" id="fecha_sintoma_reinfeccion" class="form-control" value="<?php echo $fechaServidor; ?>" >
                          </div>
                        </div>
                        <div class="form-group col-sm-12">
                          <div class="form-group col-sm-4">
                          ...
                          <div class="form-group col-sm-4">
                            ...
                            <input type="date" tabindex="32"  name="fecha_resultado_reinfeccion" id="fecha_resultado_reinfeccion" class="form-control" value="<?php echo $fechaServidor; ?>" >
                          </div>
                          <div class="form-group col-sm-4">
              ...
              <div class="box-body">
                <div class="form-group col-sm-12">
                  {!! Form::submit('Continuar', ['class' => 'btn btn-success']) !!}
                    <a href="{!! route('aislamientos.listar_fichas',[$id, $dni]) !!}" class="btn btn-danger">Cancelar</a>
                </div>
              </div>
            {!! Form::close() !!}
          </div>
