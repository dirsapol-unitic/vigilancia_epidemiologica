          ...
          {!! Form::model($archivos, ['route' => ['aislamientos.store_evolucion_paciente'], 'method' => 'patch','enctype'=>"multipart/form-data",'id'=>'frm_aislamientos','name'=>'frm_aislamientos']) !!} 
            <div class="box-body">
              <div class="row col-sm-12">
                  @if($evolucion->evolucion!=8 or $evolucion->evolucion!=4 or $evolucion->evolucion!=5 )
                      <div class="form-group col-sm-3">
                          ...
                          <select class="form-control select2" tabindex="47" required="" style="width: 100%" onchange="getEvolucion();" name="evolucion" id="evolucion">
                              ...
                              <option value="9" <?php if($evolucion->evolucion == 9)echo "selected='selected'";?>>En Observación</option>
                              <option value="10" <?php if($evolucion->evolucion == 10)echo "selected='selected'";?>>Estable</option>
                              <option value="11" <?php if($evolucion->evolucion == 11)echo "selected='selected'";?>>Estacionario</option>
                              <option value="8" <?php if($evolucion->evolucion == 8)echo "selected='selected'";?>>Alta Médica/Hospitalaria </option>
                              <option value="4" <?php if($evolucion->evolucion == 4)echo "selected='selected'";?>>Alta Médica/Aislamiento</option>
                              ...
                              <option value="7" <?php if($evolucion->evolucion == 7)echo "selected='selected'";?>>Fugado</option>
                              ...
                              <input type="hidden" name="idficha" id="id_evolucion" value="{{$idficha}}">
                          </select><br/><br/>
                      </div>
