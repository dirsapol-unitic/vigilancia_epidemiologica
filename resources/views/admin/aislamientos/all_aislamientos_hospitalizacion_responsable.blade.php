        ...
        <div class="box-body">
            <div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                <div class="panel-body">
                    <div class="col-sm-12">
                        <form id="frm_asilamientos_pnp" class="form-horizontal" method="post" action="{{ route('aislamientos.listar_aislamientos_hospitalizacion')}}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <br/><br/>
                                    <a class="btn btn-success form-control input-sm" href="javascript:void(0)" onclick="reporteHospitalizadosR()" >
