                              ...
                              <div class="box-body">
                                  <div class="row col-sm-12">
                                    <div class="form-group col-sm-2">
                                        ...
                                        <input type="date" tabindex="3"  required="" name="fecha_notificacion" id="fecha_notificacion" class="form-control" value="{{$ficha->fecha_notificacion}}" >
                                    </div>
                                    <div class="form-group col-sm-2">
                                    ...
                                    <div class="form-group col-sm-2" id="divtipocaso2">
                                        <label>F. inicio de sintomas</label><br/>
                                        <input type="date" tabindex="3"  name="fecha_sintoma" id="fecha_sintoma" class="form-control" value="{{$antecedentes->fecha_sintoma}}" >
                                    </div>
                                    @else
                                    <div class="form-group col-sm-2" id="divtipocaso">
                                        <label>F. inicio de sintomas</label><br/>
                                        <input type="date" tabindex="3"  name="fecha_sintoma" id="fecha_sintoma" class="form-control" value="{{$antecedentes->fecha_sintoma}}" >
                                    </div>
                                    @endif
                                    <div class="form-group col-sm-2">
                                        <label>F. inicio de aislamiento</label><br/>
                                  ...
                                  <div class="row col-sm-12">
                                      <div class="form-group col-sm-4">
                                          ...
                                          <input type="text" tabindex="8" name="otro_sintoma" id="otro_sintoma" value="{{$antecedentes->otro_sintoma}}" class="form-control">
                                      </div>
                                      <div class="form-group col-sm-4">
                                          <br/>
                                          <label>Signos</label> 
                                          ...
                                          <label>Otro, especificar:</label><br/>
                                          <input type="text" tabindex="9" name="otro_signo" id="otro_signo" value="{{$antecedentes->otro_signo}}" class="form-control"> 
                                      </div>
                                      <div class="form-group col-sm-4">
                                          <br/>
                                          ...
                                          <label>Otro, especificar:</label><br/>
                                          <input type="text" tabindex="10" name="otro_factor_riesgo" value="{{$antecedentes->otro_factor_riesgo}}" id="otro_factor_riesgo" class="form-control">
                                      </div>
                                      ...
                                      <div class="row col-sm-12">
                                          <div class="form-group col-sm-4">
                                            ...
                                            <select class="form-control select2" tabindex="11" style="width: 100%" onchange="getOtroContacto2();" name="contacto_directo" id="contacto_directo">
                                                ...
                                                <option value="NN" <?php if($antecedentes->contacto_directo == 'NN')echo "selected='selected'";?>>Desconocido</option>
                                            </select>
                                          ...
                                          <div class="form-group col-sm-4">
                                              <br/>
                                              <label>Ficha de Inv. Epidemiologica/Ficha Contacto </label> <b><span font-size="8" style="color:red"> (Si la Rpta es SI, se habilitara el formulario de Contacto)</span> </b> 
                                              <br/>
                                    ...
                                    @if($antecedentes->caso_reinfeccion == 'SI')
                                      <div class="col-md-12"> 
                                        <div  id="divreinfeccion2" style="display:none">
                                          <div class="form-group col-sm-12">
                                            ...
                                            <div class="form-group col-sm-4">
                                              ...
                                              @if($antecedentes->sintoma_reinfeccion== 'SI')
                                                <input type="date" tabindex="30"  name="fecha_sintoma_reinfeccion" id="fecha_sintoma_reinfeccion" class="form-control" value="{{  $antecedentes->fecha_sintoma_reinfeccion }}" >
                                              @else
                                                <input type="date" tabindex="30"  name="fecha_sintoma_reinfeccion" id="fecha_sintoma_reinfeccion" class="form-control" value="" >
                                              @endif
                                            </div>
                                          </div>
                                          <div class="col-md-12"> 
                                            ...
                                            <div class="form-group col-sm-4">
                                              ...
                                              @if($antecedentes->prueba_confirmatoria!= 0)
                                                <input type="date" tabindex="32"  name="fecha_resultado_reinfeccion" id="fecha_resultado_reinfeccion" class="form-control" value="{{$antecedentes->fecha_resultado_reinfeccion}}" >
                                              @else
                                                <input type="date" tabindex="30"  name="fecha_resultado_reinfeccion" id="fecha_resultado_reinfeccion" class="form-control" value="" >
                                              @endif
                                            </div>
                                            <div class="form-group col-sm-4">
                                    ...
                                    @endif
                                    <div class="col-md-4">
                                      <label>Está Hospitalizado?</label><b><span font-size="8" style="color:red"> (Si la Rpta es SI, se habilitara el formulario de Hospitalizacion)</span> </b> 
                                      <br/>
                                      <select class="form-control select2" tabindex="39" name="caso_hospitalizado" id="caso_hospitalizado">
                                          <option value="">- Seleccione -</option>
                                          <option value="SI" <?php if($ficha->hospitalizado == 'SI')echo "selected='selected'";?>> SI </option>
                                          <option value="NO" <?php if($ficha->hospitalizado == 'NO')echo "selected='selected'";?>> NO </option>
                                      </select>
                                      <br/>
                                      <br/>
                                    </div>
                                    <div class="col-md-12">                
                                        ...
                                        <input type="hidden" name="idficha" id="idficha" value="<?php echo $ficha->id?>">
                                        <br/><br/><br/>
                                    </div>
                                  </div>
                              </div>
                          ...
                          <div class="box-body">
                              <div class="form-group col-sm-12">
                                  ...
                                  @if($ficha->hospitalizado=='NO')
                                    @if($nro_lab>0)
                                      <a href="{!! route('aislamientos.cerrar_ficha',[$idficha, $id_paciente, $dni]) !!}" class="btn btn-primary">Cerrar Ficha</a>
                                    @endif
                                  @else
