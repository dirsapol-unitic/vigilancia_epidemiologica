                    ...
                    <div class="box-body">
                        <div class="row col-sm-12">
                            <div class="form-group <?php  if($paciente->sw==false) echo 'col-sm-6'; else echo'col-sm-10'?>">
                                ...
                                <input type="hidden" name="sexo" id="sexo" value="{{$paciente->nomsexo}}">
                            ...
                            <div class="form-group col-sm-2">
                                ...
                                <select class="form-control select2" tabindex="10" disabled="disabled" required="" name="cmbsexo" id="cmbsexo">
                        ...
                        <div class="row col-sm-12">
                            ...
                            <div class="form-group col-sm-2">
                                ...
                                <input type="text" tabindex="11" name="fecha_nacimiento" readonly="" value="{{$paciente->fecnacafiliado}}" id="fecha_nacimiento" class="form-control" maxlength="10">
                            </div>
                            <div class="form-group col-sm-2">
                                <label>Edad</label><br/>
                                <input type="text" tabindex="12" name="age" readonly="" value="{{$paciente->age}}" id="age" class="form-control" maxlength="10">
                                <input type="hidden" name="edad" id="edad" value="{{$paciente->edadafiliado}}">
                            </div>
                            <div class="form-group col-sm-2">
                        ...
                        <div class="row col-sm-12">
                            ...
                            <div class="form-group col-sm-2">
                                ...
                                <input type="text" tabindex="17" readonly="" name="talla" id="talla" value="{{$paciente->estatura}}" class="form-control" maxlength="3">
                            </div>
                        </div>
                        <div class="row col-sm-12">
                            <div class="form-group col-sm-6">
                                <label>Domicilio Actual:</label><br/>
                                <input type="text" tabindex="18"  value="{{$paciente->domicilio}}" name="domicilio" id="domicilio" class="form-control">
                            </div>
                            <div class="form-group col-sm-6">
                            ...
                            <div class="row col-sm-10">
                                <div class="row col-sm-12">
                                    ...
                                    <!--div class="form-group col-sm-2">
                                        ...
                                        <input type="text" tabindex="17" readonly="" name="departamento" id="departamento" value="{{$paciente->departamento}}" class="form-control" maxlength="3">
                                        <input type="hidden" name="id_departamento" id="id_departamento" value="0">
                                        <input type="hidden" name="nombre_dpto" id="nombre_dpto">
                                    </div>
                                    <div class="form-group col-sm-3">
                                        <label>Provincia:</label><br/>
                                        <input type="text" tabindex="17" readonly="" name="provincia" id="provincia" value="{{$paciente->provincia}}" class="form-control" maxlength="3">
                                        <input type="hidden" name="id_provincia" id="id_provincia" value="0">
                                        <input type="hidden" name="nombre_prov" id="nombre_prov">
                                    </div>
                                    <div class="form-group col-sm-3">
                                        <label>Distrito:</label><br/>
                                        <input type="text" tabindex="17" readonly="" name="distrito" id="provincia" value="{{$paciente->distrito}}" class="form-control" maxlength="3">
                                        <input type="hidden" name="id_distrito" id="id_distrito" value="0">
                                        <input type="hidden" name="nombre_dist" id="nombre_dist">
                                    </div-->
                                    <div class="form-group col-sm-2">
                                        <label>Departamento:</label><br/>
