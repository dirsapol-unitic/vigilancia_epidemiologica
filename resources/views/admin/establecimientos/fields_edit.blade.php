...
<div class="form-group col-sm-4">
    ...
    <select class="form-control select2" tabindex="10" required="" name="provincia" id="provincia">
        <option value="0">- Seleccione -</option>
            ...
            <option value="{{$prov->id}}"<?php if($prov->id==$id_provincia) echo 'selected'; ?>>{{$prov->nombre}}</option>
            @endforeach
    </select>
    <br/>
</div>
<div class="form-group col-sm-4">
    ...
    <select class="form-control select2" tabindex="11" required="" name="distrito" id="distrito">
        <option value="0">- Seleccione -</option>
            ...
            <option value="{{$dist->id}}"<?php if($dist->id==$id_distrito) echo 'selected'; ?>>{{$dist->nombre}}</option>
            @endforeach
    </select>
    <br/>
</div>
