...
function getTipoCaso(){
    var id_tipo_caso        = $('#id_tipo_caso').val();
    if(id_tipo_caso=='1'){
        $("#divtipocaso").show();
    }
    else{
...
function AddDiagnostico(){
    ...
    newRow +='<tr>';
    newRow +='<td><input type="text" data-toggle="tooltip" data-placement="top" title="Ingresar el diagnostico" name="nombre_diagnostico[]" tabindex="8" id="nombre_diagnostico'+ind+'" class="input-sm" style="margin-left:4px; width:100%; text-align:left" />';
    ...
    newRow +='<td><select class="form-control id_tipo_diagnostico" id="cmbTipoDiagnostico'+ind+'" name="id_tipo_diagnostico[]" style="margin:0 20px;width:150px">'+item_tipo_diagnostico+'</select></td>';
