                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    @foreach($vacunas as $key => $vacuna)
                        <tr>
                            ...
                            <td>
                                {!! Form::open(['route' => ['vacunas.destroy', $vacuna->id], 'method' => 'delete']) !!}
                                <div class='btn-group'>
                                    <a href="{!! route('vacunas.edit', [$vacuna->id]) !!}" class='btn btn-primary btn-xs'><i class="glyphicon glyphicon-edit"></i></a>
