      ...
      <div class="nav-tabs-custom">
        <div class="tab-content">
          ...
          <div class="box-header">
            <a class="btn btn-app pull-right" style="margin-top: -10px;margin-bottom: 5px" href="{!! route('aislamientos.create_evolucion',[$id, $dni]) !!}"><i class="glyphicon glyphicon-file"></i>Nuevo </a>
          </div>
          @endif
          <div class="content">
                      ...
                      <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <a href="{!! route('aislamientos.editar_evolucion', [$row->id,$dni, $id]) !!}" class='btn btn-primary btn-xs'><i class="glyphicon glyphicon-edit"></i></a>
