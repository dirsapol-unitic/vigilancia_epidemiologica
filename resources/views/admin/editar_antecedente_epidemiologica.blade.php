                              ...
                              <div class="box-body">
                                  <div class="row col-sm-12">
                                    ...
                                    <div class="form-group col-sm-3">
                                      ...
                                      <select class="form-control select2" tabindex="2" required="" name="id_tipo_caso" id="id_tipo_caso">
                                          <option value="">- Seleccione -</option>
                                    ...
                                    <div class="form-group col-sm-3">
                                        ...
                                        <input type="date" tabindex="3"  name="fecha_sintoma" id="fecha_sintoma" class="form-control" value="<?php echo date("Y-m-d", strtotime($antecedentes->fecha_sintoma)); ?>" >
                                    </div>
                                    <div class="form-group col-sm-3">
                                        <label>Fecha  de inicio de aislamiento</label><br/>
                                        <input type="date" tabindex="4"  name="fecha_aislamiento" id="fecha_aislamiento" class="form-control" value="<?php echo date("Y-m-d", strtotime($antecedentes->fecha_aislamiento)); ?>" >
                                    </div>
                                  </div>
                                  <div class="row col-sm-12">
