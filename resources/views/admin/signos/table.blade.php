<div class="row">
    ...
    @foreach($signos as $key => $signo)
        <tr>
            ...
            <td>
                {!! Form::open(['route' => ['signos.destroy', $signo->id], 'method' => 'delete']) !!}
                <div class='btn-group'>
                    <a href="{!! route('signos.edit', [$signo->id]) !!}" class='btn btn-primary btn-xs'><i class="glyphicon glyphicon-edit"></i></a>
