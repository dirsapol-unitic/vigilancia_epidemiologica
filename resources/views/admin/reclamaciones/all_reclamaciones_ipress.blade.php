                        ...
                        <form class="form-horizontal" method="post" action="{{ route('reclamaciones.listar_reclamaciones')}}">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <select class="form-control input-sm select2" name="id_ipress" id="id_ipress" tabindex="16" style="width: 100%">
                                        <option value="0">-Todas-</option>
                                        <?php
                                        foreach ($establecimientos as $d) {
                                            echo '<option value="' . $d->id . '"';
                                            if (isset($id_establecimiento)) {
                                                if ($id_establecimiento == $d->id)
                                                    echo " selected";
                                            }
                            ...
                            <div class="row">
                                <div class="col-md-2">
                                    ...
                                    <select class="form-control input-sm select2" name="tiempo"  id="tiempo" tabindex="15" style="width: 100%">
                                        <option value="4" <?php if (isset($tiempo) && $tiempo == 4) echo "selected='selected'"; ?>>Todas </option>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <select class="form-control input-sm select2" name="estado"  id="estado" tabindex="15" style="width: 100%">   
                                        <option value="3" <?php if (isset($estado) && $estado == 3) echo "selected='selected'"; ?>>Todas</option>                                    
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input value="T1" name="tipo_consulta" type="hidden">
                                </div>
                                <div class="col-md-3">                                    
                        ...
                        <table id="example" class="table table-list-search table-hover" style="font-size: 11px !important;" >
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <div style="color:black;float:right;margin-right:0%;font-size:11px">N/A</div>
                                    <?php } else { ?>
                                    ...
                                    <td class="text-center">
                                        <?php if (isset($estado) && $estado == 0) { ?>
                                            <div data-toggle="tooltip" data-placement="top" data-html="true" title="<b>Solucionar reclamacion</b>">
                                                <button type="button" class="btn btn-primary btn-xs" disabled=""><i class="fa fa-fw fa-edit"></i></button>
                                            </div>
                                        <?php } else { ?>
                                        <div data-toggle="tooltip" data-placement="top" data-html="true" title="<b>Solucionar reclamacion</b>">
